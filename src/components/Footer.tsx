      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-10">
          <div className="col-span-1">
            ...
            <ul className="space-y-1.5 md:space-y-2 text-gray-400 text-sm md:text-base">
              ...
              <li><a href="#" className="hover:text-red-600 transition-colors">History</a></li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-1.5 md:space-y-2 text-gray-400 text-sm md:text-base">
              <li><a href="#" className="hover:text-red-600 transition-colors">Elden Ring</a></li>
              <li><a href="#" className="hover:text-red-600 transition-colors">Armored Core VI</a></li>
              <li><a href="#" className="hover:text-red-600 transition-colors">Sekiro</a></li>
              <li><a href="#" className="hover:text-red-600 transition-colors">Dark Souls Series</a></li>
              <li><a href="#" className="hover:text-red-600 transition-colors">Bloodborne</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1 mt-6 sm:mt-0">
            ...
            <ul className="space-y-1.5 md:space-y-2 text-gray-400 text-sm md:text-base">
              ...
              <li><a href="#" className="hover:text-red-600 transition-colors">Customer Service</a></li>
              <li><a href="#" className="hover:text-red-600 transition-colors">Technical Support</a></li>
          ...
          <div className="col-span-2 sm:col-span-1 mt-6 md:mt-0">
            ...
            <div className="flex justify-center sm:justify-start space-x-3 mb-4 md:mb-6">
              <a href="#" className="bg-gray-800 hover:bg-red-800 transition-colors p-2 rounded-full">
        ...
        <div className="border-t border-gray-800 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-wrap justify-center md:justify-start gap-3 md:gap-4 mb-3 md:mb-0">
            ...
            <a href="#" className="text-xs text-gray-500 hover:text-gray-300 transition-colors">Legal</a>
          </div>
